...
export default function Message(){
    return(
            ...
            <form id="sendMessage" className="p-[1rem] flex flex-col gap-6">
  ...
  <option value="" disabled hidden>
    Select a service...
                        ...
                        <div className="w-[100%] flex flex-col gap-2">
                            ...
                            <button className="text-center w-[100%] font-bold rounded-lg py-[0.7rem] hover:bg-black hover:text-[var(--secondary)] bg-[var(--secondary)]" type="submit">
